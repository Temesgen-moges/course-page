...
const Footer = () => {
  return (
    <div style={{ backgroundColor: '#252641' }}  className="footer flex flex-col items-center justify-center text-center  ">
  <div className="w-64 flex text-center justify-between mt-12 text-white">
    <div className="md:mr-10">Logo</div>
    <div className="borleft md:pl-10 mb-12"> 
  ...
  <button className="md:ml-5 inputradius border bg-[#49BBBD] md:px-10 font-bold text-white">Subscribe</button>
